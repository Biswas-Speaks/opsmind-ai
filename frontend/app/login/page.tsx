...
import { Cpu, AlertTriangle, KeyRound, Mail } from 'lucide-react';
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-12 text-slate-100">
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-800 bg-slate-900/60 p-8 shadow-2xl backdrop-blur-sm">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-6 text-xl font-bold tracking-tight">Sign in to your account</h2>
          <p className="mt-2 text-sm text-slate-400">
            Enter your credentials to access the ops console
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="admin@opsmind.local"
                  {...register('email')}
        ...
        {/* Demo Accounts List */}
        <div className="rounded-lg border border-slate-800 bg-slate-950/40 p-4 mt-6 text-xs text-slate-400 space-y-2">
          <p className="font-bold text-slate-300">Quick-Access Demo Accounts:</p>
          <ul className="list-disc pl-4 space-y-1">
            <li><strong>Super Admin:</strong> admin@opsmind.local / admin123</li>
            <li><strong>IT Manager:</strong> manager@opsmind.local / manager123</li>
            <li><strong>IT Engineer:</strong> engineer@opsmind.local / engineer123</li>
            <li><strong>Employee:</strong> employee@opsmind.local / employee123</li>
          </ul>
        </div>
        ...
        <p className="text-center text-sm text-slate-400">
          Need an account?{' '}
          <Link href="/signup" className="font-medium text-blue-500 hover:text-blue-400 hover:underline">
            Register here
          </Link>
        </p>
